...
| Puntos                 | Indicador numérico opcional que muestra la puntuación del usuario.     |
  ...
  argTypes: {
    name: {
      control: 'text',
      description: 'Nombre del usuario a mostrar en el perfil. Máx. 30 caracteres recomendados',
      table: {
        type: { summary: 'string' },
        category: 'User Info'
      }
    ...
    points: {
      control: 'text',
      description: 'Puntos o valoración del usuario (ej: "1.250 pts", "Gold Member")',
      table: {
        type: { summary: 'string' },
        category: 'User Info'
      }
    ...
    showName: {
      ...
      description: 'Controla si el nombre del usuario debe mostrarse. Útil para vistas compactas',
      table: {
    ...
    showPoints: {
      control: { type: 'boolean' },
      description: 'Determina si los puntos/valoración son visibles. Desactivar para perfiles simples',
      table: {
        type: { summary: 'boolean' },
        defaultValue: { summary: 'true' },
        category: 'Visibility'
